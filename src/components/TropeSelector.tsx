...
const tropeColorMap: TropeInfo[] = [
  ...
  { name: "Dark Romance", color: "#87252D", description: "Darker, intense, and morally complex themes" },
  { name: "Accidental Pregnancy", color: "#8ED3FB", description: "Symbolizes hope, new beginnings, and a fresh chapter in life" }
];
